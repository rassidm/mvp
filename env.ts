...
const BUNDLE_IDS = {
  development: 'com.ourmorocco.development',
  preview: 'com.ourmorocco.preview',
  production: 'com.ourmorocco',
} as const;
...
const SCHEMES = {
  development: 'ourmorocco',
  preview: 'ourmorocco.preview',
  production: 'ourmorocco',
} as const;

const NAME = 'ourmorocco';
